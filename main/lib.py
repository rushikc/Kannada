...
stop_words = firebase.get('/stop_words',None)
# tenses = firebase.get('/tenses',None)
past_future = firebase.get('/past_future',None)
item={}
# item['tenses'] = [t.encode('utf-8') for t in tenses]
item['past_future'] = [t.encode('utf-8') for t in past_future]
# tenses = item['tenses']
past_future = item['past_future']

happy = firebase.get('/happy',None)
sad = firebase.get('/sad',None)
surprise = firebase.get('/surprise',None)
angry = firebase.get('/angry',None)
fear = firebase.get('/fear',None)
